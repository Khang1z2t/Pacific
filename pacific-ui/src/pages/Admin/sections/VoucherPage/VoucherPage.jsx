...
export const VoucherPage = () => {
    ...
    const fetchAllData = useCallback(async () => {
        ...
        try {
            ...
            // Ánh xạ active thành status và lọc bỏ voucher có deleteAt
            const filteredVouchers = voucherResponse.data
                .map((voucher) => ({
                    ...voucher,
                ...
                .filter((voucher) => !voucher.deleteAt);
    ...
    const handleDeleteVoucher = useCallback(
        async () => {
            try {
                setLoading(true);
                await VoucherServices.deleteVoucher(selectedVoucher.id);
