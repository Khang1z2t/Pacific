...
const Booking = () => {
    ...
    const [bookings, setBookings] = useState([
        { id: 1, name: "Long Đại", bookingId: "ID98", tour: "Hạ Long Bay", date: "2025/02/22", payment: "Thanh toán online", status: "Chưa thanh toán", price: "9.000.000 đ", discount: 0 },
        { id: 2, name: "Tí Điệu", bookingId: "ID29", tour: "Hạ Long Bay", date: "2025/02/22", payment: "Thanh toán online", status: "Đã hùy", price: "19.000.000 đ", discount: 0 },
    ]);
