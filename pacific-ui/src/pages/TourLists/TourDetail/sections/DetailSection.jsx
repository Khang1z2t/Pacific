...
const DetailSection = ({tourDT}) => {
    ...
    const price = tourDT.priceAdults;
    ...
    return (
        <div className="flex justify-between px-8 py-6">
            ...
            <Card className="max-w-sm p-4 shadow-xl ms-10 rounded-2xl">
                <h2 className="text-2xl font-semibold mb-4 text-red-600">Giá: {tourDT.priceAdults} / Khách</h2>
                ...
                <div className="space-y-2">
                    ...
                    <p><strong>Khởi hành:</strong> {tourDT.destination}</p>
                    <p><strong>Ngày khởi hành:</strong> {tourDT.createdAt}</p>
                    <p><strong>Thời gian:</strong> 3N2Đ</p>
                    <p><strong>Số chỗ còn:</strong> 9 chỗ</p>
                </div>
                <div className="flex space-x-4 mt-4">
                    <Button
                        onClick={() => navigate(config.routes.booking + `${tourDT.tour.id}`)}
