    ...
    return (
        <Card className="w-[500px] h-fit sticky top-24 transition-all p-4 shadow-lg border rounded-xl">
            ...
            <div className="text-sm text-gray-700">
                ...
                <p>
                    <strong>Ngày đi:</strong> {config.webConfig.convertDateNoTime(detailData.startDate)}
                </p>
                <p>
                    <strong>Ngày về:</strong> {config.webConfig.convertDateNoTime(detailData.endDate)}
                </p>
                <h3 className="text-lg font-bold flex items-center gap-2 mt-2">
                    <FaHotel className="text-orange-400" /> Thông tin khách sạn
                </h3>
                <p>
                    <strong>Khách sạn:</strong> {hotel.name || 'Đang tải...'}
                </p>
                <p>
                    <strong>Giá:</strong> {config.webConfig.getCurrency(hotel.cost) || 'N/A'}
                </p>
                <h3 className="text-lg font-bold flex items-center gap-2 mt-2">
                    <FaPlaneDeparture className="text-orange-400" /> Thông tin phương tiện
                </h3>
                <p>
                    <strong>Phương tiện:</strong> {transport.name || 'Đang tải...'}
                </p>
                <p>
