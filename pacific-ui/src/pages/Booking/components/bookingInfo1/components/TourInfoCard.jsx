...
const TourInfoCard = memo(
    ({ data, detailData, adults, children, totalPrice, voucherValid, discount, hotel, transport }) => {
            ...
            <Card className="w-full max-w-[500px] p-4 shadow-lg border rounded-xl xl:sticky xl:top-24">
                ...
                <div className="text-xs sm:text-sm text-gray-700">
                    <h3 className="text-base sm:text-lg font-bold flex items-center gap-2">
                        <FaInfoCircle className="text-indigo-500" aria-hidden="true" /> Thông tin
                        chuyến đi
                    </h3>
                    <p>
                    ...
                    <h3 className="text-base sm:text-lg font-bold flex items-center gap-2 mt-2">
                        <FaHotel className="text-orange-400" aria-hidden="true" /> Thông tin khách
                        sạn
                    </h3>
                    <p>
                    ...
                    <h3 className="text-base sm:text-lg font-bold flex items-center gap-2 mt-2">
                        <FaPlaneDeparture className="text-orange-400" aria-hidden="true" /> Thông tin
                        phương tiện
                    </h3>
                    <p>
                ...
                <div className="text-xs sm:text-sm text-gray-700">
                    <h3 className="text-base sm:text-lg font-bold flex items-center gap-2">
                        <BiSolidUserDetail className="text-orange-400" aria-hidden="true" /> Khách
                        hàng + Phụ thu
                    </h3>
                    <p>
                ...
                <span className="text-xs text-red-500 mt-2 block">
                    * Giá trên đã bao gồm các phụ thu: giá dịch vụ, giá vé máy bay, giá khách sạn, giá
                    ăn uống, giá vận chuyển, giá phí tham quan, giá phí hướng dẫn viên, giá phí bảo
                    hiểm, giá phí visa, giá phí phục vụ, giá phí khác.
                </span>
                <Divider className="my-3" />
