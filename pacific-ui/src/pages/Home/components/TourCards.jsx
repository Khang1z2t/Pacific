        ...
        >
            <Link to={config.routes.tourDetail + `${data.id}`}>
                ...
                <div className={'p-3 sm:p-4'}>
                    <h3 className={'text-base sm:text-lg font-semibold overflow-ellipsis text-gray-800 mb-2 line-clamp-2'}>{data.title}</h3>
                ...
                <div className="flex flex-col justify-start border-t p-2 sm:p-3">
                    ...
                    <div className={'flex flex-wrap gap-2 items-center'}>
                        <p className="text-base sm:text-lg font-bold text-gray-800">{config.webConfig.getCurrency(data.maxPrice)}</p>
                    </div>
                </div>
            </Link>
