        ...
        <div className="min-h-screen flex items-center justify-center">
            ...
            <div className="bg-white relative p-8 rounded-lg shadow-lg w-full uppercase max-w-2xl">
                ...
                <Form className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium">{t("register.ti8")}<span className={'text-red-500'}>*</span></label>
                    ...
                    <p className="col-span-2 text-sm text-red-500"><span className={'text-red-500'}>(*)</span> {t("register.ti13")}</p>
